            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active && "bg-surface text-white shadow-glow"
                )}
              >
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="flex items-center gap-6 text-sm">
              <div>
                ...
                <span className="ml-2 font-semibold">25884.80</span>
                <span className="ml-1 text-danger">-74.70 (-0.29%)</span>
              </div>
              <div>
                <span className="text-text-secondary">SENSEX</span>
                <span className="ml-2 font-semibold">84587.01</span>
                <span className="ml-1 text-danger">-313.73 (-0.37%)</span>
              </div>
            </div>
          </div>
