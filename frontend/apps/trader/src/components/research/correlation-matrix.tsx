        ...
        return (
            <div className="space-y-3">
                ...
                <div className="rounded-xl border border-[#2d303a]/40 bg-[#1a1d24] p-4">
                    <div className="h-32 rounded-lg bg-[#2d303a]/30 animate-pulse" />
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-3">
            ...
            <p className="text-[10px] text-[#8b8f9a]">
                Shows how stocks move together (+1: perfect positive, -1:
                perfect negative)
            </p>
                ...
                <div className="overflow-x-auto">
                    <table className="w-full border-collapse text-xs">
                        <thead>
                            <tr>
                                ...
                                {symbols.map((symbol) => (
                                    <th
                                        key={symbol}
                                        className="p-2 text-center font-medium text-[#8b8f9a]"
                                    >
                                        {symbol}
                                    </th>
                                ))}
                        ...
                        <tbody>
                            {symbols.map((symbol1) => (
                                <tr key={symbol1}>
                                    <td className="p-2 font-medium text-[#8b8f9a]">
                                        {symbol1}
                                    </td>
                                    {symbols.map((symbol2) => {
                                        const correlation =
                                        ...
                                        return (
                                            <td key={symbol2} className="p-1">
                                                <div
                                                    ...
                                                    title={`Correlation: ${correlation.toFixed(
                                                        3
                                                    )}`}
                                                >
            ...
            <div className="rounded-xl border border-[#2d303a]/40 bg-[#1a1d24] p-3">
                ...
                <ul className="space-y-1 text-[10px] text-[#8b8f9a]">
                    <li>
                        • Stocks with high positive correlation move together
                    </li>
                    <li>• Negative correlation helps reduce portfolio risk</li>
                    <li>
                        • Aim for low/negative correlations for better
                        diversification
                    </li>
                </ul>
            </div>
